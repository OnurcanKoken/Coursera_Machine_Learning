...
def convolutional_block(X, f, filters, stage, block, s = 2):
    ...
    # Be careful that you use the X at the beginning layer [l], so use X_shortcut!
...
# modellerin icinde kullanilan 2a, 2b, gibi isimler cok onemli, dikkatli ol, tum layerlar unique olmali
